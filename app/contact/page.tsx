...
const Page = () => {
  return (
    <div className="flex flex-row w-full h-screen">
      ...
      src={contactImg}  
      alt="Contact" 
        className=" lg:h-[90%] w-auto  rounded-md md-hide p-12 self-center" 
      />
      </div>
      <Separator className="mt-5 h-[80%] self-center" orientation="vertical" />
      <div className="flex flex-col w-1/2 h-full relative p-2">
        <p className="md:text-center md:text-lg text-justify text-xs justify-center md:m-2 lg:m-8 px-6 items-centers font-raleway">
        ...
        <section className="flex md:flex-col flex-col items-center justify-center w-full">
          <div className="flex flex-col items-center m-2">
            {cards.map((card, index) => (
              <Card key={index} className="md:max-w-[340px] w-[340px] h-[150px] md:h-[160px] flex justify-center items-center bg-opacity-0 border-none shadow-none">
