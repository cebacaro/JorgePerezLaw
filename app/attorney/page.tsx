...
const reviews =[
  ...
  {
    "author_name": "Jane DoeCristhian Buezo:", 
    "rating": 5,
...
const Page = () => {
  ...
  return (
    ...
    height={1080}
      ...
      />
      <section className="absolute inset-0 flex flex-col items-center justify-center backdrop-filter backdrop-blur-md bg-opacity-20 bg-black z-10 min-h-screen my-14">
       <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mx-20 overflow-auto" >
      {reviews.map((review, index) => (
        <div key={index} className="border border-gray-300 p-4 rounded-lg bg-black/15 bg-opacity-50">
